...
API_INC+= ${BILAT_IMAGE_JNI_PATH}/$(subst ${SEPARATOR}, ${BILAT_IMAGE_JNI_PATH}/,${BILAT_IMAGE_JNI_INC})

#Linkage
#Use SrcAux car nom lib complexe!
SRC_AUX+= ${BILAT_IMAGE_JNI_PATH}/$(subst ${SEPARATOR}, ${BILAT_IMAGE_JNI_PATH}/,${BILAT_IMAGE_JNI_LIB})  

#Runtime
API_BIN+= ${BILAT_IMAGE_JNI_PATH}/$(subst ${SEPARATOR}, ${BILAT_IMAGE_JNI_PATH}/,${BILAT_IMAGE_JNI_BIN})
