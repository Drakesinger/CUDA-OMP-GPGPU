...
TARGET_NAME:=BilatTools_Cuda_Priority
...
include $(API)/openmp.mk #pour BilatTools_CPP

include $(API_BILAT_IMAGE_CUDA)/bilat_image_gl_cuda.mk
include $(API_BILAT_IMAGE_CUDA)/bilat_image_freeglut_cuda.mk
include $(API_BILAT_IMAGE_CUDA)/bilat_image_jni_cuda.mk
