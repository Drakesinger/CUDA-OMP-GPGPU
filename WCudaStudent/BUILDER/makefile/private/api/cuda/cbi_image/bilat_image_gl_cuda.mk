...
API_INC+= ${BILAT_IMAGE_GL_CUDA_PATH}/$(subst ${SEPARATOR}, ${BILAT_IMAGE_GL_CUDA_PATH}/,${BILAT_IMAGE_GL_CUDA_INC})

#Linkage
#Use SrcAux car nom lib complexe!
SRC_AUX+= ${BILAT_IMAGE_GL_CUDA_PATH}/$(subst ${SEPARATOR}, ${BILAT_IMAGE_GL_CUDA_PATH}/,${BILAT_IMAGE_GL_CUDA_LIB})  

#Runtime
API_BIN+= ${BILAT_IMAGE_GL_CUDA_PATH}/$(subst ${SEPARATOR}, ${BILAT_IMAGE_GL_CUDA_PATH}/,${BILAT_IMAGE_GL_CUDA_BIN})
